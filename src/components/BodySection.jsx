...
const BodySection = () => {
  ...
  const [moringa,setMoringa] = useState(true)
    ...
    <div className="transition-all duration-300 ease-in-out grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-1 bg-[#222228]">
      <div className="flex justify-center h-[100%] w-[100%] col-span-1  items-center text-center align-right">
        <div className="w-[100%] h-[550px] flex justify-center items-center text-center align-center">
          <div className="w-[90%] h-[70%] rounded-[5px]  bg-[#31313a]  ">
            ...
            education ? <div className="w-[100%] p-[20px]  text-center justify-center over flex  flex-col-reverse align-center items-center ">
              <div className=" ">
                <div className="w-[100%] grid lg:grid-cols-2 md:grid-col-2 sm:grid-col-2 grid-col-2">
                  ...
                  <div class='flex items-center justify-center '>
                  <div class={moringa?"rounded-[3px] border p-5 shadow-md w-9/12 bg-[#e5e7eb] transition-all duration-300 ease-in-out visible":"invisible transition-all duration-300 ease-in-out"}>
                      <div class="flex w-full items-center justify-between border-b pb-3">
                        <div class="flex items-center space-x-3">
                      ...
                      <div>
                        <div class="flex items-center justify-between text-slate-500">
                          <div class="flex space-x-4 md:space-x-8">
                            ...
                            <button onClick={()=>{setMoringa(!moringa)}} className="btn gap-2 mt-5 p-1 h-[40px] text-[10px]  border-none hover:bg-[#239B56] btn-sm   lg:w-[40%] bg-[#2ECC71] sm:w-40% md:w-[30%] rounded-[50px]  ">
                              Certificate
 </button>
                          </div>
                        </div>
                    ...
                    <img src="https://res.cloudinary.com/dqab6gg7d/image/upload/v1672757913/Portfolio/Flatiron_Certificate_page-0001_y5vvs8.jpg" className={moringa?"transition-all duration-300 ease-in-out h-0 w-0 ":"rounded-[3px]  p-5 shadow-md w-9/12 h-[315px] first-letter: object-contain transition-all duration-300 ease-in-out"}> 
                    </img>
                  </div>
