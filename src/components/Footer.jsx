...
const Footer = () => {
  return (
    <>
    <footer className="footer p-10 text-white bg-[#31313a] ">
  <div>
...
<footer className="footer px-10 py-4  text-white  bg-[#222228]">
  ...
  <div className="md:place-self-center md:justify-self-end">
    <div className="grid grid-flow-col gap-4">
      ...
      {/* <footer className="footer p-10  bg-[#31313a] text-neutral-content">
        <div>
          <svg
            width="50"
            height="50"
